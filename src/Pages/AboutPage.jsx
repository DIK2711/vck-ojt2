        ...
        <div className="page">
            ...
            <div id="scroller">
                <h1 className="h">About Vivekanand College</h1>
                 ...
                 <h2 className="h1">Our Values</h2>
                 <p className="p">Integrity, Excellence, Innovation, Community, and Respect are the pillars upon which Vivekanand College is built. We encourage open dialogue, intellectual curiosity, and a relentless pursuit of knowledge.

</p>
<h2 className="h1">Our History</h2>

<p className="p">[Briefly describe the college's history - e.g., how it started, key milestones, growth over the years, famous alumni if any]. Our journey began with a vision to make quality education available to all, and we continue that legacy today.
